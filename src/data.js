...
export const PROJECTS = [
  {
    id: 'mailroom',
    name: 'Mailroom',
    client: 'Regional law firm · 14 attorneys',
    tag: 'Email automation',
    summary: 'An autonomous intake agent that reads every email, opens matters in Clio, drafts boilerplate replies, and routes the rest to the right paralegal.',
    metrics: [
      { v: '38 hrs', l: 'saved per week' },
      { v: '<2 min', l: 'response time' },
      { v: '$11.2k', l: 'monthly savings' },
    ],
  ...
  },
  {
    ...
    client: 'Medspa chain · 6 locations',
    tag: 'Voice agent',
    summary: 'After-hours voice agent that handles bookings, FAQs, and intake screening across six locations — fluent in English and Spanish.',
    metrics: [
      { v: '212', l: 'after-hr bookings/mo' },
      { v: '94%', l: 'caller satisfaction' },
      { v: '11 sec', l: 'avg answer time' },
    ],
  ...
  },
  {
    id: 'proposalforge',
    name: 'ProposalForge',
    client: 'Commercial roofing co. · $14M ARR',
    tag: 'Document generation',
    summary: 'Feed it job-site photos and a customer brief. Out comes a fully-priced, branded, signature-ready proposal in 90 seconds flat.',
    metrics: [
      { v: '90 sec', l: 'time to proposal' },
      { v: '3.4×', l: 'proposals/week' },
      { v: '+22%', l: 'close rate' },
    ],
  ...
  },
  {
    id: 'scout',
    name: 'Scout',
    client: 'DTC supplements brand',
    tag: 'Competitive intelligence',
    summary: 'Watches 38 competitor sites, ad libraries, and review pages every 4 hours. Drops a one-page Monday brief on what changed and what to do about it.',
    metrics: [
      { v: '38 sites', l: 'monitored' },
      { v: '4 hrs', l: 'refresh cadence' },
  ...
  },
  {
    id: 'reconcile',
    name: 'Reconcile',
    client: 'E-commerce · $4.2M GMV',
    tag: 'Bookkeeping ops',
    summary: 'Parses every invoice, receipt, and bank line. Reconciles to Xero. Flags variances. Closes the books 22 days earlier each month.',
    metrics: [
      { v: '22 days', l: 'faster month-end' },
      { v: '0', l: 'manual entries' },
      { v: '99.7%', l: 'reconciliation rate' },
    ],
  ...
  },
  {
    id: 'briefroom',
    name: 'Briefroom',
    client: 'Boutique agency · 24 people',
    tag: 'Knowledge ops',
    ...
    metrics: [
      { v: '8,400+', l: 'meetings indexed' },
      { v: '<3 sec', l: 'avg lookup' },
